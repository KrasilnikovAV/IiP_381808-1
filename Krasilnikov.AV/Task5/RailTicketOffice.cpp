...
// ‘ункци¤ провер¤ет, сободны ли места
// —начала считает все свободные места в вагоне и сравнивает с нужным колличеством
...
// ‘ункци¤ возвращает стоимость билетов
